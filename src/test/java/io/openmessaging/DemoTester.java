...
public class DemoTester {
    ...
    public static void main(String args[]) throws Exception {
        ...
        int sendTime = 100 * 600;
        //查询阶段的最大持续时间，也即在该时间内，如果消息依然没有消费完毕，则退出评测
        int checkTime = 100 * 600;
...
//                    System.out.println(aIndex1+" "+aIndex2+" "+tIndex1+" "+tIndex2);
                    //验证消息
                    ...
                    while (iter.hasNext()) {
                        if (index1 > index2) {
                            ...
                            while (iter.hasNext()){
                                ...
                                System.out.println("shengyu:"+msg.getT()+" "+msg.getA());
                            }
                            checkError();
                        }
                        ...
                        if (msg.getA() != msg.getT() || msg.getA() != index1 ||
                            ...
                            System.out.println("2"+" "+msg.getT()+" "+msg.getA()+" "+index1+" "+i);
                            checkError();
                        ...
                        if ((index1 & 0x1) == 0 && iter.hasNext()) {
                            ...
                            if (msg.getA() != msg.getT() || msg.getA() != index1
                                    || ByteBuffer.wrap(msg.getBody()).getLong() != index1) {
                                System.out.println("3"+" "+msg.getT()+" "+msg.getA()+" "+index1);
                                checkError();
                            }
                            i++;
                        }
